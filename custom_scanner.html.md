...
Note that you can also use scanners directly as Inspect scorers (see
...
- `messages` — Filter for message types: `"all"` or a list like
  `["user", "assistant"]`.
...
re-scanned with the updated scanner.
