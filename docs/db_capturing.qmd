...
::: {.callout-note}
Note that the transcript capture feature described below are available only in the development version of Inspect Scout. Install the development version from GitHub with:
