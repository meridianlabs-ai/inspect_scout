...
2. You can create a [Gated Dataset](https://huggingface.co/docs/hub/datasets-gated) that requires users to share contact and optionally other information to obtain access.
