...
::: {.callout-note}
Note that the programmatic access to schema described below is available only in the development version of Inspect Scout. Install the development version from GitHub with:
