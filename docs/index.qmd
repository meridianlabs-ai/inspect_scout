...
2.  Analyze transcripts from Inspect Evals, Arize Phoenix, LangSmith, Logfire, or custom sources via the capture and import APIs.
...
5.  Scale to thousands of transcripts with parallel processing, batching, and fault tolerance.
