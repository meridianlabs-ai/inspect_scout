...
-   [LLM Scanner](llm_scanner.qmd): High-level LLM scanner for model evaluation of transcripts.

-   [Workflow](workflow.qmd): Workflow for the stages of a transcript analysis project.

There is also more in depth documentation available on [Scanners](scanners.qmd), [Results](results.qmd), [Validation](validation.qmd) and [Transcript Databases](transcript_databases.qmd).