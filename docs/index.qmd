...
Scout can directly analyze Inspect AI eval logs or alternatively take input from a [transcript database](db_overview.qmd) (which can be populated from any source).
