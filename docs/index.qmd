...
3.  Convert the message history into a string for presentation to the model. The `messages_as_str()` function will by default remove system messages from the list. See `ContentPreprocessor` for other available options.
