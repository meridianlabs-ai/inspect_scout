...
Traditionally, evaluation and scanning workflows have assumed that single conversation trajectory (message list) represents an agent's activity. However, modern coding agents like Claude Code and Codex CLI create many additional dimensions to consider:
...
(2) Compaction often further divides trajectories into multiple-phases (wherby the compacted away messages can be lost in updates to the conversation).
