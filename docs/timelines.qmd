...
Built-in reducers include `ResultReducer.any`, `.mean`, `.median`, `.mode`, `.max`, `.min`, `.union`, `.last`.
...
no_utility = filter_timeline(timeline, lambda s: not s.utility)
```
