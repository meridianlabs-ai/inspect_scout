---
title: Transcripts
llms-description: "Reading and filtering transcripts for scanning"
---
...
See the `Columns` documentation for additional details on supported filtering operations. 
...
transcript.metadata["sample_metadata"]  # sample metadata (full, unless the scanner passes metadata=False)
