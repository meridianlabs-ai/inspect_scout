...
3.  [Building a Scanner](#building-a-scanner) — Authoring, debugging, and testing a scanner.

4.  [Scanner Validation](#scanner-validation) — Validating scanners against human labeled results.

5.  [Analyzing Results](#analyzing-results) — Visualizing and analyzing scanner data frames.

6.  [Running Scanners](#running-scanners) — Best practices for running scanners in production.
