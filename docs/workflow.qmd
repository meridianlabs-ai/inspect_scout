...
All configuration within the project file will be automatically applied to the `scout scan`. See the article on [Projects](projects.qmd) to learn more about using projects.
