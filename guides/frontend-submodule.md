...
| Task | Before | Now |
|------|--------|----|
| Where frontend code lives | `src/inspect_scout/_view/www/` in this repo | Separate repo, mounted at `src/inspect_scout/_view/ts-mono/` via submodule |
...
Of course, you can also keep a dedicated terminal `cd`'d into `src/inspect_scout/_view/ts-mono/apps/scout/` for day-to-day frontend work — whatever feels natural.
