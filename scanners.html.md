...
We can use this in Inspect `Task` as follows:
...
If you are interfacing with a library that expects only `Scorer`
instances, you can also use the `as_scorer()` function from Inspect
Scout to adapt your scanner:
