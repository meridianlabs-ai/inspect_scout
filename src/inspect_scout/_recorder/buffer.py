        ...
        records = [
            cast(
                dict[str, str | bool | int | float | None],
                {
                    ...
                    "transcript_task_set": transcript.task_set,
                    "transcript_task_id": transcript.task_id,
                    "transcript_task_repeat": transcript.task_repeat,
                    "transcript_agent": transcript.agent,
                    "transcript_agent_args": transcript.agent_args,
                    "transcript_model": transcript.model,
                    "transcript_score": transcript.score,
                    "transcript_success": transcript.success,
                    "transcript_total_time": transcript.total_time,
                    "transcript_total_tokens": transcript.total_tokens,
                    "transcript_error": transcript.error,
                    "transcript_limit": transcript.limit,
