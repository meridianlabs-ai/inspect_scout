"""Temporary fork of `inspect_ai.model.stable_message_ids`.

Temporary replacement for ``inspect_ai.model.stable_message_ids``.
See https://github.com/UKGovernmentBEIS/inspect_ai/pull/4407

Will remove this module once that is merged.
"""
...
def stable_message_ids() -> Callable[[Sequence[ChatMessage] | ModelEvent], None]:
    ...
    def apply_ids(target: Sequence[ChatMessage] | ModelEvent) -> None:
        ...
        if hasattr(target, "event") and target.event == "model":
