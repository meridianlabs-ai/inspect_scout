import { j as jsxRuntimeExports, g as clsx, r as reactExports, k as reactDomExports, bT as Link } from "./index.js";
...
function formatPrettyDecimal(num, maxDecimals = 3) {
  const numDecimalPlaces = num.toString().includes(".") ? num.toString().split(".")[1]?.length || 0 : 0;
...
function centerTruncate(str, maxLength = 50) {
  ...
  const start2 = str.slice(0, startLength);
  const end2 = str.slice(-endLength);
  return start2 + ellipsis + end2;
}
function formatPercent(value, maxDecimals) {
  return `${formatPrettyDecimal(value * 100, maxDecimals)}%`;
}
const join = (file, dir) => {
  if (!dir) {
    return file;
...
const wrapper = "_wrapper_xqbef_1";
const container$1 = "_container_xqbef_12";
const animate = "_animate_xqbef_21";
const styles$4 = {
  wrapper,
...
const LoadingBar = ({ loading }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clsx(styles$4.wrapper), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      "aria-valuemin": 0,
      "aria-valuemax": 100,
      children: loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.animate })
    }
  ) });
};
...
const PopOver = ({
  ...
  const isOverPopoverRef = reactExports.useRef(false);
  const dismissalTimerRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    ...
    if (!isOpen || hoverDelay <= 0) {
      ...
      const captureListener = (event) => {
        mouseDownInsidePopover = popperRef.current?.contains(event.target) ?? false;
      };
  ...
  reactExports.useEffect(() => {
    ...
    const handlePopoverMouseLeave = (e) => {
      if (e.relatedTarget && popperRef.current?.contains(e.relatedTarget)) {
        return;
      }
  ...
  const popperContent = /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref: popperRef,
      style: { ...defaultPopperStyles, ...positionedStyle, ...styles2 },
...
const EditableText = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: containerRef, className: clsx(styles$3.container, className), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: clsx(styles$3.labelContainer), title, children: [
        icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `${icon2} ${styles$3.icon}` }),
        label && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$3.label, children: label })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          ...
          className: clsx(
            styles$3.text,
            !value ? styles$3.placeholder : "",
            !editable ? styles$3.readOnly : ""
          ),
          onFocus: handleFocus,
          onBlur: handleBlur,
    ...
    mru && mru.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      PopOver,
      {
        ...
        showArrow: false,
        offset: [0, 4],
        className: clsx(styles$3.mruPopover, "text-size-smallest"),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.mruList, children: filteredMru.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: clsx(
              styles$3.mruItem,
              index === selectedMruIndex && styles$3.mruItemSelected
            ),
...
const NavButtons = ({ buttons }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: buttons.map(
    (button, index) => button.enabled !== false ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      "span",
      {
        className: clsx(styles$1.toolbarButton, styles$1.disabled),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: clsx(button.icon) })
      },
      index
    )
...
const Navbar = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clsx(leftButtons2 ? styles$2.leftButtons : void 0), children: leftButtons2 && /* @__PURE__ */ jsxRuntimeExports.jsx(NavButtons, { buttons: leftButtons2 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clsx(leftButtons2 ? styles$2.left : void 0), children: left2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: clsx(styles$2.right, right2 ? styles$2.hasChildren : void 0),
            children: right2
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: clsx(rightButtons2 ? styles$2.rightButtons : void 0), children: rightButtons2 && /* @__PURE__ */ jsxRuntimeExports.jsx(NavButtons, { buttons: rightButtons2 }) })
      ]
    }
  );
};
const toolButton = "_toolButton_wcmr6_1";
const marginRight = "_marginRight_wcmr6_6";
const latched = "_latched_wcmr6_18";
const subtle = "_subtle_wcmr6_25";
const styles = {
  toolButton,
  marginRight,
  latched,
...
const ToolButton = reactExports.forwardRef(
  ({ label, classes = "", icon: icon2, className, latched: latched2, subtle: subtle2, ...rest }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ref,
        ...
        className: clsx(
          ...
          classes,
          className,
          latched2 ? styles.latched : void 0,
          subtle2 ? styles.subtle : void 0
        ),
        ...rest,
        children: [
          icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: clsx(icon2, label ? styles.marginRight : void 0) }),
          label
        ]
      }
    );
