import { r as reactExports, h as reactDomExports, j as jsxRuntimeExports, c as clsx } from "./index.js";
...
const formatTime = (seconds) => {
  if (seconds < 60) {
    ...
    return sec > 0 ? `${min2} min ${sec} sec` : `${min2} min`;
...
function formatDurationShort(start2, end2) {
  const totalSec = Math.round((end2.getTime() - start2.getTime()) / 1e3);
...
const ToolButton = reactExports.forwardRef(
  ({ label, classes = "", icon, className, latched: latched2, subtle: subtle2, ...rest }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        ...rest,
        children: [
          icon && /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: clsx(icon, label ? styles.marginRight : void 0) }),
          label
        ]
      }
    );
