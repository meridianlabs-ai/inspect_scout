...
import { r as reactExports, N as prismExports, j as jsxRuntimeExports, c as clsx, u as useStore, O as debounce$1, G as useParams, P as parseTranscriptParams, i as useSearchParams, x as transcriptRoute, R as React, g as fo, A as ApplicationIcons, _ as __vitePreload, m as useLoggingNavigate, Q as iconForMimeType, S as isHostedEnvironment, C as lib$1, T as useExtendedFind } from "./index.js";
...
const ToolTextOutput = ({ text: text2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: clsx(styles$v.textOutput, "tool-output"), children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: clsx("sourceCode", styles$v.textCode), children: text2.trim() }) });
};
