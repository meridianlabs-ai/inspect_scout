...
const kScanRouteUrlPattern = "/scan/:scan_location";
const scansRoute = () => "/scans";
const ScanDetail = () => {
  const { scan_location } = useParams();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { "aria-label": "breadcrumb", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "breadcrumb", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "breadcrumb-item active", "aria-current": "page", children: scan_location })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-body", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: scan_location }) }),
...
const ScanList = () => {
  ...
  reactExports.useEffect(() => {
    const fetchScans = async () => {
      const scans2 = await api2?.getScans();
      if (scans2) {
        setScans(scans2);
      }
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "list-group", children: scans.map((scan) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        to: `/scan/${encodeURIComponent(scan.location)}`,
        className: "list-group-item list-group-item-action",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex w-100 justify-content-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-file-earmark-text me-2" }),
            scan.location || "Unnamed Scan"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: scan.location }) })
        ]
      },
      scan.location
    )) }),
    scans.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "alert alert-info", role: "alert", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-info-circle me-2" }),
      "No scans available."
    ] })
  ] }) }) });
