...
export interface Request<T> {
  ...
  /**
   * When true, omits Cache-Control/Pragma/Expires headers to enable browser
   * caching with ETag support. The browser will automatically handle
   * If-None-Match headers and 304 responses.
   */
