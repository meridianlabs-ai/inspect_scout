# scan-result-legibility – Inspect Scout
...
**Files:** - Modify: `apps/scout/src/app/scannerResult/ScannerResultPanel.tsx`
...
**Files:** - Modify: `apps/scout/src/app/scannerResult/result/ResultBody.tsx` - Modify: `apps/scout/src/app/scannerResult/result/ResultPanel.tsx`
...
Remove these imports (no longer needed): - `useNavigate` from `react-router-dom` (line 3) - `transcriptRoute` from `../../../router/url` (line 10) - `ColumnHeaderButton` from `../../components/ColumnHeader` (line 16 — keep `ColumnHeader`) - `ApplicationIcons` from `../../../icons` (line 9)
