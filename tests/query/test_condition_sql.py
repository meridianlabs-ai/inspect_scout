...
class TestConditionAsSql:
    ...
    def test_less_than(self) -> None:
        c = Column("score") < 0.5
        assert condition_as_sql(c) == "score < 0.5"
...
class TestRoundtrip:
    ...
    def test_not_roundtrip(self) -> None:
        ...
        sql = condition_as_sql(original)  # "NOT (model = 'gpt-4')"
        restored = condition_from_sql(sql)
