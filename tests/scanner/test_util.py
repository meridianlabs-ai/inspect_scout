...
@pytest.mark.parametrize(
    "input_value,expected_type,expected_id",
    [
...
def test_heterogeneous_sequence_raises_error() -> None:
    """Sequence with mixed message and event types raises ValueError."""
    ...
    with pytest.raises(ValueError, match="All items in sequence must be"):
        get_input_type_and_ids(heterogeneous)  # type: ignore[arg-type]
