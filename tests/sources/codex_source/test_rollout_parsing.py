"""Unit tests for codex rollout file discovery and reading.

Tests for the rollout envelope/model parsing and event conversion that these
readers feed live upstream in inspect_swe (tests/test_codex_rollout_models.py
and tests/test_codex_rollout_conversion.py there).
"""
